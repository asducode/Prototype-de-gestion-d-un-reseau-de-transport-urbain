...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        System.out.println("1- Afficher la liste des stations ordonées");
        System.out.println("2- Afficher la liste des lignes ordonées");
        ...
        if (choix1 == 2) {
            ...
            // si l'utilisateur n'est pas une personne à mobilité réduite
