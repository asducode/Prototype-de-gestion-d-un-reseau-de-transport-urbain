...
public class GraphFactory {
    ...
    /**
     * Crée un graphe représentant le réseau de transport en commun de Brackenford.
     ...
     * @return Un graphe représentant le réseau de transport en commun de Brackenford.
     */
...
/**
 * Création d'un graphe pour les utilisateurs n'ayant pas d'handicap et souhaitant prendre le chemin le moins chère .  
...
/** 
 * Création d'un graphe pour les utilisateurs ayant un handicap souhaitant prendre le chemin le plus court pour un itinéraire .
 * @param stations : Liste des stations du reseau de Backenford.
 * @param lignes : Liste des lignes de transport du reseau de Backenford.
 * @return Un graphe représentant le réseau de transport en commun de Brackenford.
 */
...
/** 
 * Création d'un graphe pour les utilisateurs ayant un handicap souhaitant prendre le chemin le moins chère pour un itinéraire .
 * @param stations : Liste des stations du reseau de Backenford.
 * @param lignes : Liste des lignes de transport du reseau de Backenford.
 * @param passager : le passager qui utilise le réseau de transport en commun.
 * @return Un graphe représentant le réseau 
 * */
    ...
    private static final double rayonTerre = 6364673; // Rayon moyen de la Terre en mètres
    ...
    public static double convertirEnRadians(double[] valeurs) {
        ...
        double degres = valeurs[0];
        double minutes = valeurs[1] / 60.0;
        double secondes = valeurs[2] / 3600.0;
